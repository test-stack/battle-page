              ...
              <div className="card-block">
                ...
                <form name="product-form" action="" onSubmit={(e) => this.props.submit(e)} noValidate>
                  <div className="form-group">
                    ...
                    <input type="text" className="form-control" id="topic" aria-describedby="topicHelp"
                           placeholder="Vyplňte téma Todo" onChange={() => this.props.setItem()}/>
                  </div>
                  <div className="form-group">
                    <label htmlFor="exampleInputPassword1">Tagy</label>
                    <input type="text" className="form-control" id="tags" placeholder="Zadejte tagy oddělené čárkou"
                           onChange={() => this.props.setItem()}/>
                  </div>
                  <div className="form-group">
                  ...
                  <div className="form-group">
                    ...
                    <textarea className="form-control" id="description" rows="3" placeholder="Zadejte popis Todo"
                              onChange={() => this.props.setItem()}></textarea>
                  </div>
                    ...
                    <div className="form-check">
                      <label className="form-check-label">
                        <input type="radio" className="form-check-input" name="optionsRadios" id="optionsRadios1"
                               value="shareOff" onChange={() => this.props.setItem()} defaultChecked/>
                        {' '}Ne
                      </label>
                    </div>
                    <div className="form-check">
                      <label className="form-check-label">
                        <input type="radio" className="form-check-input" name="optionsRadios" id="optionsRadios2"
                               value="shareOn" onChange={() => this.props.setItem()}/>
                        {' '}Ano
                      </label>
                    </div>
                  </fieldset>
                  <div className="form-check">
                    <label className="form-check-label">
                      <input type="checkbox" className="form-check-input" name="optionsRadios" id="notification"
                             onChange={() => this.props.setItem()}/>
                      {' '}Zapnout upozornění
                    </label>
                  </div>
                  ...
                  <div className="container-fluid" id="formFooter">
                    <div className="row top-buffer">
                      ...
                      <div className="col-md-10">
                        ...
                        <div className={ `alert alert-${this.props.successSaved ? 'success' : 'danger'}` } role="alert"
                             id="saveBox">
